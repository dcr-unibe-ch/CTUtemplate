...
gtsummary shows total Ns by default, which can lead to confusion, especially with regards the calculation of percentages in the presence of missing data. 
